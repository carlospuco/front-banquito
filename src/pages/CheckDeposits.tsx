...
const CheckDeposits = () => {
    ...
    return (
        <>
            <Box>
                <Typography variant='h4' align='center'>Depósitos Cheque</Typography>
            </Box>
            <Box
                sx={
                    formBoxStyle()
                ...
                <Box
                    ...
                    <Box
                        ...
                        <Typography>Número de cheques</Typography>
                        <TextFieldAtom
                            id="outlined-basic-filled"
                            label=""
                            color="success"
                            type="number"
                            placeholder="Número de cheques"
                            variant="filled"
                        />
                    </Box>
                    <Box
                        ...
                        <Typography>Valor Cheque</Typography>
                        <TextFieldAtom
                            id="outlined-basic-filled"
                            label=""
                            color="success"
